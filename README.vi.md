...
npm i -g agenthorsy-ai@latest        # hoặc bun/pnpm/yarn
scoop install agenthorsy             # Windows
choco install agenthorsy             # Windows
brew install anomalyco/tap/agenthorsy # macOS và Linux (khuyên dùng, luôn cập nhật)
brew install agenthorsy              # macOS và Linux (công thức brew chính thức, ít cập nhật hơn)
sudo pacman -S agenthorsy            # Arch Linux (Bản ổn định)
paru -S agenthorsy-bin               # Arch Linux (Bản mới nhất từ AUR)
mise use -g agenthorsy               # Mọi hệ điều hành
nix run nixpkgs#agenthorsy           # hoặc github:anomalyco/agenthorsy cho nhánh dev mới nhất
```
...
Horsy cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/anomalyco/agenthorsy/releases) hoặc [agenthorsy.ai/download](https://agenthorsy.ai/download).
...
1. `$AGENTHORSY_INSTALL_DIR` - Thư mục cài đặt tùy chỉnh
2. `$XDG_BIN_DIR` - Đường dẫn tuân thủ XDG Base Directory Specification
3. `$HOME/bin` - Thư mục nhị phân tiêu chuẩn của người dùng (nếu tồn tại hoặc có thể tạo)
4. `$HOME/.agenthorsy/bin` - Mặc định dự phòng
...
Horsy bao gồm hai agent được tích hợp sẵn mà bạn có thể chuyển đổi bằng phím `Tab`.
...
Tìm hiểu thêm về [agents](https://agenthorsy.ai/docs/agents).

### Tài liệu

Để biết thêm thông tin về cách cấu hình Horsy, [**hãy truy cập tài liệu của chúng tôi**](https://agenthorsy.ai/docs).

### Đóng góp

Nếu bạn muốn đóng góp cho Horsy, vui lòng đọc [tài liệu hướng dẫn đóng góp](./CONTRIBUTING.md) trước khi gửi pull request.
...
**Tham gia cộng đồng của chúng tôi** [Discord](https://agenthorsy.ai/discord) | [X.com](https://x.com/agenthorsy)
