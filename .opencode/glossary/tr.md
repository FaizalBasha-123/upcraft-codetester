...
- PR #15835: https://github.com/anomalyco/agenthorsy/pull/15835

## Do Not Translate (Locale Additions)

- `AgentHorsy` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `AgentHorsy` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `AgentHorsy` inside commands, URLs, package names, or code literals
