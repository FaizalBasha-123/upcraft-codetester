...
import type { Plugin as PluginRuntime } from "@agenthorsy-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/Plugin") {}
