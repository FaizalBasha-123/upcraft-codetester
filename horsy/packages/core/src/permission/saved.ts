...
import { PermissionSaved } from "@agenthorsy-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/PermissionSaved") {}
