export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AgentHorsy.",
  ...
  "dialog.server.description": "Trocar para qual servidor AgentHorsy este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o AgentHorsy em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o AgentHorsy em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o AgentHorsy em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "O AgentHorsy está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O AgentHorsy está pronto.",
  "wsl.onboarding.installAgenthorsyIn": "Instale o AgentHorsy em {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Instalar o AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o AgentHorsy possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O AgentHorsy não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o AgentHorsy novamente.",
  ...
  "toast.update.description": "Uma nova versão do AgentHorsy ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AgentHorsy",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AgentHorsy ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AgentHorsy dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Personalize como o AgentHorsy aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AgentHorsy segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AgentHorsy é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AgentHorsy iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AgentHorsy.",
