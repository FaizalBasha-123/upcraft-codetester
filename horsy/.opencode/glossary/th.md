...
- PR #10809: https://github.com/anomalyco/agenthorsy/pull/10809
- PR #11496: https://github.com/anomalyco/agenthorsy/pull/11496

## Do Not Translate (Locale Additions)

- `AgentHorsy` (preserve casing in prose; keep `opencode` only in commands, package names, paths, or code)
- `AgentHorsy CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
