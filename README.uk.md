...
Якщо ви працюєте над проєктом, пов'язаним з Horsy, і використовуєте "opencode" у назві, наприклад "agenthorsy-dashboard" або "agenthorsy-mobile", додайте примітку до свого README.
