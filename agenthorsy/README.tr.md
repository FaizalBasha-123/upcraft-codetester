...
# Paket yöneticileri
npm i -g agenthorsy-ai@latest        # veya bun/pnpm/yarn
scoop install agenthorsy             # Windows
choco install agenthorsy             # Windows
brew install anomalyco/tap/agenthorsy # macOS ve Linux (önerilir, her zaman güncel)
brew install agenthorsy              # macOS ve Linux (resmi brew formülü, daha az güncellenir)
sudo pacman -S agenthorsy            # Arch Linux (Stable)
paru -S agenthorsy-bin               # Arch Linux (Latest from AUR)
mise use -g agenthorsy               # Tüm işletim sistemleri
nix run nixpkgs#agenthorsy           # veya en güncel geliştirme dalı için github:anomalyco/agenthorsy
```
...
Horsy ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/agenthorsy/releases) veya [agenthorsy.ai/download](https://agenthorsy.ai/download) adresinden indirebilirsiniz.
...
1. `$AGENTHORSY_INSTALL_DIR` - Özel kurulum dizini
2. `$XDG_BIN_DIR` - XDG Base Directory Specification uyumlu yol
3. `$HOME/bin` - Standart kullanıcı binary dizini (varsa veya oluşturulabiliyorsa)
4. `$HOME/.agenthorsy/bin` - Varsayılan yedek konum
...
Horsy, `Tab` tuşuyla aralarında geçiş yapabileceğiniz iki yerleşik (built-in) ajan içerir.
...
[Ajanlar](https://agenthorsy.ai/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

Horsy'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://agenthorsy.ai/docs).

### Katkıda Bulunma

Horsy'a katkıda bulunmak istiyorsanız, lütfen bir pull request göndermeden önce [katkıda bulunma dokümanlarımızı](./CONTRIBUTING.md) okuyun.
...
**Topluluğumuza katılın** [Discord](https://agenthorsy.ai/discord) | [X.com](https://x.com/agenthorsy)
