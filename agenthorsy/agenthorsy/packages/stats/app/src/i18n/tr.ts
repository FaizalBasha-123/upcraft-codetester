export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AgentHorsy Data",
  "app.description":
    "AgentHorsy Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AgentHorsy Data logosu",
  ...
  "header.githubAria": "GitHub'da AgentHorsy'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAgentHorsy": "AgentHorsy'u dene",
  ...
  "footer.homeAria": "AgentHorsy ana sayfası",
  ...
  "modal.title": "AgentHorsy Bülteni",
  ...
  "home.topModelsDescription": "AgentHorsy Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AgentHorsy Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AgentHorsy Data",
  "lab.description":
    "AgentHorsy Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son AgentHorsy kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AgentHorsy'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AgentHorsy kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AgentHorsy token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AgentHorsy Data",
  "model.description":
    "{{model}} için AgentHorsy Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AgentHorsy Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki AgentHorsy Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AgentHorsy Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AgentHorsy Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son AgentHorsy Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AgentHorsy Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AgentHorsy Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AgentHorsy Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AgentHorsy Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan AgentHorsy Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen AgentHorsy Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son AgentHorsy Go token hacmine göre yakındaki modeller.",
