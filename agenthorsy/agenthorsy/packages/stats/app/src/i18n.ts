...
const en = {
  "app.title": "AI Model Usage Rankings | AgentHorsy Data",
  "app.description":
    "Explore AgentHorsy Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "AgentHorsy Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AgentHorsy on GitHub",
  "header.github": "GitHub",
  "header.tryAgentHorsy": "Try AgentHorsy",
  ...
  "footer.homeAria": "AgentHorsy home",
  ...
  "home.topModelsDescription": "Usage of models across AgentHorsy Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique AgentHorsy Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AgentHorsy Data",
  "lab.description":
    "Compare {{lab}} models used in AgentHorsy Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent AgentHorsy usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AgentHorsy",
  ...
  "lab.shareOfUsage": "{{share}} of recent AgentHorsy usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AgentHorsy Data",
  "model.description":
    "View {{model}} AgentHorsy Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AgentHorsy Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AgentHorsy Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's AgentHorsy Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AgentHorsy Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no AgentHorsy Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "AgentHorsy Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No AgentHorsy Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent AgentHorsy Go token volume.",
