export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの AgentHorsy を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "AgentHorsy のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'agenthorsy' コマンドを使用してください。",
