...
beforeAll(async () => {
  ...
  mock.module("@agenthorsy-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@agenthorsy-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@agenthorsy-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@agenthorsy-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
