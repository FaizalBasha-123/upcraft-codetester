...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "AgentHorsy Documentation", href: "https://agenthorsy.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/anomalyco/agenthorsy/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/agenthorsy/issues/new?template=bug_report.yml",
      },
    ],
  },
]
