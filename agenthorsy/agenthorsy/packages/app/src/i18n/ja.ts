export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "AgentHorsyが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、AgentHorsyで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAgentHorsyで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、AgentHorsyで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するAgentHorsyサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "AgentHorsyを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAgentHorsyを確認中...",
  "wsl.onboarding.updatingOpencode": "AgentHorsyを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAgentHorsyを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAgentHorsyを更新してください。",
  "wsl.onboarding.updateOpencode": "AgentHorsyを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のAgentHorsyの準備ができました。",
  "wsl.onboarding.opencodeReady": "AgentHorsyの準備ができました。",
  "wsl.onboarding.installAgenthorsyIn": "{{distro}}にAgentHorsyをインストールしてください。",
  "wsl.onboarding.installAgenthorsy": "AgentHorsyをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsyがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentHorsyでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、AgentHorsyをもう一度開いてください。",
  ...
  "toast.update.description": "AgentHorsyの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAgentHorsyチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AgentHorsyはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsyには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAgentHorsyサーバーを実行します。",
  ...
  "settings.general.row.language.description": "AgentHorsyの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAgentHorsyの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "AgentHorsyがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "AgentHorsyのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "AgentHorsy の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "AgentHorsy は最新バージョンです。",
