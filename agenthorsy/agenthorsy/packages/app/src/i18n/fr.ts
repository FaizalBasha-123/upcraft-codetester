export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AgentHorsy.",
  ...
  "dialog.server.description": "Changez le serveur AgentHorsy auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'AgentHorsy dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'AgentHorsy dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour AgentHorsy dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy est prêt.",
  "wsl.onboarding.installAgenthorsyIn": "Installez AgentHorsy dans {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Installer AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'AgentHorsy puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez AgentHorsy.",
  ...
  "toast.update.description":
    "Une nouvelle version d'AgentHorsy ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AgentHorsy",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AgentHorsy ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AgentHorsy inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AgentHorsy dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AgentHorsy sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AgentHorsy suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AgentHorsy.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AgentHorsy",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AgentHorsy.",
