export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i AgentHorsy.",
  ...
  "dialog.server.description": "Skift hvilken AgentHorsy-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker AgentHorsy i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer AgentHorsy i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater AgentHorsy i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før AgentHorsy kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter AgentHorsy igen.",
  ...
  "toast.update.description": "En ny version af AgentHorsy ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AgentHorsy-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AgentHorsy understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AgentHorsy-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan AgentHorsy ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om AgentHorsy følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan AgentHorsy er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AgentHorsy starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AgentHorsy.",
