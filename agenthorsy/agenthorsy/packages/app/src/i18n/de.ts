...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in AgentHorsy zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "agenthorsy.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in AgentHorsy zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in AgentHorsy zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den AgentHorsy-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "AgentHorsy",
  ...
  "wsl.onboarding.checkingOpencode": "AgentHorsy wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "AgentHorsy in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "AgentHorsy wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "AgentHorsy in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie AgentHorsy in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AgentHorsy aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "AgentHorsy ist bereit.",
  "wsl.onboarding.installAgenthorsyIn": "Installieren Sie AgentHorsy in {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "AgentHorsy installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor AgentHorsy einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann AgentHorsy erneut.",
  ...
  "toast.update.description": "Eine neue Version von AgentHorsy ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem AgentHorsy-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: AgentHorsy unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "AgentHorsy Desktop",
  ...
  "settings.desktop.wsl.description": "AgentHorsy-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für AgentHorsy ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie AgentHorsy auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob AgentHorsy dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von AgentHorsy anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von AgentHorsy automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von AgentHorsy.",
