export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك AgentHorsy Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في AgentHorsy.",
  ...
  "dialog.server.description": "تبديل خادم AgentHorsy الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من AgentHorsy في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث AgentHorsy في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث AgentHorsy في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy جاهز.",
  "wsl.onboarding.installAgenthorsyIn": "ثبّت AgentHorsy في {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "تثبيت AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن AgentHorsy من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على AgentHorsy التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح AgentHorsy.",
  ...
  "toast.update.description": "نسخة جديدة من AgentHorsy ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق AgentHorsy",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن AgentHorsy لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن AgentHorsy نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم AgentHorsy داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ AgentHorsy",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور AgentHorsy على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان AgentHorsy يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة AgentHorsy.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل AgentHorsy",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من AgentHorsy.",
