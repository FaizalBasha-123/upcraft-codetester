export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AgentHorsy.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de AgentHorsy se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando AgentHorsy en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando AgentHorsy en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza AgentHorsy en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy está listo.",
  "wsl.onboarding.installAgenthorsyIn": "Instala AgentHorsy en {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Instalar AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que AgentHorsy pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir AgentHorsy.",
  ...
  "toast.update.description": "Una nueva versión de AgentHorsy ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de AgentHorsy",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, AgentHorsy no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AgentHorsy dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve AgentHorsy en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AgentHorsy sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AgentHorsy.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AgentHorsy",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AgentHorsy.",
