...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "AgentHorsy tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AgentHorsy'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak AgentHorsy'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AgentHorsy'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AgentHorsy sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AgentHorsy kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AgentHorsy kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "AgentHorsy güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde AgentHorsy güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki AgentHorsy'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "AgentHorsy'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde AgentHorsy hazır.",
  "wsl.onboarding.opencodeReady": "AgentHorsy hazır.",
  "wsl.onboarding.installAgenthorsyIn": "AgentHorsy'u {{distro}} içine kurun.",
  "wsl.onboarding.installAgenthorsy": "AgentHorsy'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgentHorsy'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından AgentHorsy'u tekrar açın.",
  ...
  "toast.update.description": "AgentHorsy'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AgentHorsy ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AgentHorsy henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AgentHorsy Masaüstü",
  ...
  "settings.desktop.wsl.description": "AgentHorsy sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AgentHorsy'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "AgentHorsy'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AgentHorsy'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AgentHorsy'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AgentHorsy başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AgentHorsy'un en son sürümünü kullanıyorsunuz.",
