...
declare const AGENTHORSY_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AGENTHORSY_CLI_NAME === "string" ? AGENTHORSY_CLI_NAME : "opencode", {
  description: "AgentHorsy 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
