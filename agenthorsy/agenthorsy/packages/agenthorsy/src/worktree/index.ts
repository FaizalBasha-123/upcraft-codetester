...
import { path } from "@agenthorsy-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@agenthorsy-ai/core/project"
...
import { WorktreeEvent } from "@agenthorsy-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `agenthorsy/${name}`
