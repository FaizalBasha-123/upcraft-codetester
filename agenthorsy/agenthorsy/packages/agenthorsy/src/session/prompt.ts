...
import { loop as orchestratorLoop } from "../orchestrator/orchestrator"
...
import { MAX_STEPS_PROMPT } from "@agenthorsy-ai/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/SessionPrompt") {}
  ...
  Effect.gen(function* () {
    ...
    const loop: (input: LoopInput) => Effect.Effect<SessionV1.WithParts> = (Effect.fn("SessionPrompt.loop")(function* (
      ...
      return yield* state.ensureRunning(
        ...
        orchestratorLoop(input.sessionID, runLoop).pipe(Effect.orDie, Effect.provide(ctx)) as any
      )
    }) as any)
