import type { Hooks, PluginInput } from "@agenthorsy-ai/plugin"
import type { Model } from "@agenthorsy-ai/sdk/v2"
import { InstallationVersion } from "@agenthorsy-ai/core/installation/version"
import { OauthCallbackPage } from "@agenthorsy-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. AgentHorsy will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
