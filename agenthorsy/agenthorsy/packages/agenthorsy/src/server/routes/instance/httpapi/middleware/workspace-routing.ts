...
>()("@agenthorsy/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@agenthorsy/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AGENTHORSY_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AGENTHORSY_WORKSPACE_ID) : undefined
}
