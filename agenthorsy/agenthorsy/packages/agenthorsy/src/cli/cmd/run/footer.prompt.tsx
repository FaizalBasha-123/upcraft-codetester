...
import { normalizePromptContent } from "@agenthorsy-ai/tui/editor"
...
import { AGENTHORSY_BASE_MODE, useBindings } from "@agenthorsy-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close AgentHorsy" } satisfies SlashOption,
    ]
