...
import type { AssistantMessage as AgentHorsyAssistantMessage, Message } from "@agenthorsy-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@agenthorsy-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<AgentHorsyAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<AgentHorsyAssistantMessage, "role"> &
  Partial<Pick<AgentHorsyAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@agenthorsy/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@agenthorsy/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@agenthorsy/ACPUsage") {}
