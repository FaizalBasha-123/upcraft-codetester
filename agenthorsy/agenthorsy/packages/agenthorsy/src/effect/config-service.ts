 ...
 *   "@agenthorsy/ServerAuthConfig",
 *   {
 *     password: Config.string("AGENTHORSY_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AGENTHORSY_SERVER_USERNAME").pipe(Config.withDefault("agenthorsy")),
 *   },
 * ) {}
 *
