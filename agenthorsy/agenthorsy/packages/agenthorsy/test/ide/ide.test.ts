...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AGENTHORSY_CALLER", () => {
    process.env["AGENTHORSY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AGENTHORSY_CALLER", () => {
    process.env["AGENTHORSY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AGENTHORSY_CALLER", () => {
    process.env["AGENTHORSY_CALLER"] = "unknown"
