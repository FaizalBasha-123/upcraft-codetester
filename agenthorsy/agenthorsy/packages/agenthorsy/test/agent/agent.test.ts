...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      const skillDir = path.join(test.directory, ".agenthorsy", "skill", "perm-skill")
...
`,
      ...
      const home = process.env.AGENTHORSY_TEST_HOME
      process.env.AGENTHORSY_TEST_HOME = test.directory
