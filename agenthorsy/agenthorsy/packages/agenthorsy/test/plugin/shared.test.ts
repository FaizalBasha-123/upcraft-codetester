...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@agenthorsy/acme")).toEqual({
      pkg: "@agenthorsy/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@agenthorsy/acme@1.0.0")).toEqual({
      pkg: "@agenthorsy/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@agenthorsy/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@agenthorsy/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@agenthorsy/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@agenthorsy/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
