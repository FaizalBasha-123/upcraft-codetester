---
title: Condivisione
description: Condividi le tue conversazioni AgentHorsy.
---

La funzione di condivisione di AgentHorsy ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, AgentHorsy:
...
AgentHorsy supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, AgentHorsy usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `agenthorsy.json` nel progetto e versionalo su Git.
