---
title: Server LSP
description: AgentHorsy si integra con i tuoi server LSP.
---

AgentHorsy può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

AgentHorsy include diversi server LSP integrati per linguaggi popolari:
