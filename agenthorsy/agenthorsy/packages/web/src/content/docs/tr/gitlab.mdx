...
- **İş başına özel işlemleri kullanın**: opencode parçalarının kullanıma veya devre dışı bırakmak için agenthorsy'u özel bir yapılandırma dizini ile yapılandırın; örneğin `./config/#custom-directory`.
