---
title: LSP serveri
description: AgentHorsy se integriše sa vašim LSP serverima.
---

AgentHorsy se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

AgentHorsy dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
