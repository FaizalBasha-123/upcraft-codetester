...
Možete dodati prilagođene komande kroz AgentHorsy konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom AgentHorsy [config](/docs/config):
...
- Globalno: `~/.config/agenthorsy/commands/`
...
AgentHorsy uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
