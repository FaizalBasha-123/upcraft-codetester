...
يمكنك إضافة أوامر مخصصة عبر إعدادات AgentHorsy أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ AgentHorsy:
...
- على مستوى النظام: `~/.config/agenthorsy/commands/`
