---
title: خوادم LSP
description: يتكامل AgentHorsy مع خوادم LSP لديك.
---

يمكن أن يتكامل AgentHorsy مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي AgentHorsy مع عدة خوادم LSP مدمجة للغات الشائعة:
