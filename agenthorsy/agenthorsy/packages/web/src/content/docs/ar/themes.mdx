...
مع AgentHorsy يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم AgentHorsy سمتنا `opencode`.
...
يأتي AgentHorsy مع عدة سمات مدمجة.
...
- يريدون أن يطابق AgentHorsy مظهر terminal لديهم
...
يدعم AgentHorsy نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/agenthorsy/themes/*.json` أو `$XDG_CONFIG_HOME/agenthorsy/themes/*.json`
