---
title: Teilen
description: Teile AgentHorsy-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu AgentHorsy-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht AgentHorsy Folgendes:
...
AgentHorsy hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt AgentHorsy den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`agenthorsy.json` fest und committe die Datei.
