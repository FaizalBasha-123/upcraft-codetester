---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez AgentHorsy.
---
...
AgentHorsy Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół AgentHorsy.

Zen działa jak każdy inny dostawca w AgentHorsy. Logujesz się do AgentHorsy Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z AgentHorsy.
:::
...
AgentHorsy Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

AgentHorsy Zen działa jak każdy inny dostawca w AgentHorsy.

1. Logujesz się do **<a href={console}>AgentHorsy Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz AgentHorsy Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji AgentHorsy używa formatu
...
- DeepSeek V4 Flash Free jest dostępny w AgentHorsy przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w AgentHorsy przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w AgentHorsy przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w AgentHorsy przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w AgentHorsy przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy AgentHorsy Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w AgentHorsy także dowolnego innego dostawcy.
