...
- Chcą, aby AgentHorsy pasował do wyglądu ich terminala
...
2. **Katalog konfiguracji użytkownika** - Zdefiniowany w `~/.config/agenthorsy/themes/*.json` lub `$XDG_CONFIG_HOME/agenthorsy/themes/*.json`
