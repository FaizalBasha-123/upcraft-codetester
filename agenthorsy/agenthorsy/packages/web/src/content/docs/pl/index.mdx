...
Możesz także pobrać plik binarny z [Releases](https://github.com/anomalyco/agenthorsy/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [AgentHorsy Zen](/docs/zen).
Aby uzyskać dostęp do wyselekcjonowanej listy modeli, które zostały zatwierdzone i zweryfikowane przez zespół opencode.

1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [agenthorsy.ai/auth](https://agenthorsy.ai/auth).
...
Oto [przykładowa rozmowa](https://agenthorsy.ai/s/4XP1fce5) z opencode.
