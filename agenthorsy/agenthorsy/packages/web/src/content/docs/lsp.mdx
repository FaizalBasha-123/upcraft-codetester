---
title: LSP Servers
description: AgentHorsy integrates with your LSP servers.
---

AgentHorsy can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

AgentHorsy comes with several built-in LSP servers for popular languages:
...
```json title="agenthorsy.json" {5-8}
{
  "$schema": "https://agenthorsy.ai/config.json",
  "lsp": {
    "rust": {
...
```json title="agenthorsy.json" {5-13}
{
  "$schema": "https://agenthorsy.ai/config.json",
  "lsp": {
    "custom-lsp": {
