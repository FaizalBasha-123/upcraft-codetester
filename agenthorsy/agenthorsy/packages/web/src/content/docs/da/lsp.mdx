---
title: LSP-servere
description: AgentHorsy integreres med dine LSP-servere.
---

AgentHorsy kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

AgentHorsy leveres med flere indbyggede LSP-servere til populære sprog:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din agenthorsy-konfiguration.
