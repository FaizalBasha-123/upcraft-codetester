---
title: Server
description: Interact with agenthorsy server over HTTP.
---
...
:::tip
Use the opencode server to interact with agenthorsy programmatically.
:::

This architecture lets opencode support multiple clients and allows you to interact with agenthorsy programmatically.
...
The [`/tui`](#tui) endpoint can be used to drive the TUI through the server. For example, you can prefill or run a prompt. This setup is used by the AgentHorsy [IDE](/docs/ide) plugins.
