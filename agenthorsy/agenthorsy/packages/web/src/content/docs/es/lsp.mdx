...
description: AgentHorsy se integra con sus servidores LSP.
---

AgentHorsy puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

AgentHorsy viene con varios servidores LSP integrados para idiomas populares:
