...
Isso é separado do `agenthorsy.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o AgentHorsy espera depois da leader key. O padrão é `2000`.
