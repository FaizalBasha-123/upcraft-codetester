...
Du kan legge til egendefinerte kommandoer gjennom AgentHorsy-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i AgentHorsy [config](/docs/config):
...
- Globalt: `~/.config/agenthorsy/commands/`
...
AgentHorsy inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
