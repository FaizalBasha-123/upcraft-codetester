...
Agentferdigheter lar AgentHorsy oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `agenthorsy.json`:
