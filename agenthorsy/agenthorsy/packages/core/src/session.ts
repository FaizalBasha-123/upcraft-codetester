...
import { ListAnchor } from "@agenthorsy-ai/schema/session"
...
import { SessionDurable } from "@agenthorsy-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/Session") {}
