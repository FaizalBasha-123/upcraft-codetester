...
export { Effect, Rule, Ruleset } from "@agenthorsy-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/Permission") {}
