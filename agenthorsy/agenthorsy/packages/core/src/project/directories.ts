...
import type { EffectDrizzleSqlite } from "@agenthorsy-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/ProjectDirectories") {}
