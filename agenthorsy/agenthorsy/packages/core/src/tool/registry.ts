...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@agenthorsy-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/ToolRegistry") {}
