...
import { ProviderPlugins } from "@agenthorsy-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@agenthorsy-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://agenthorsy.ai/", "X-Title": "opencode" })
