# Remove `packages/agenthorsy/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/agenthorsy/src/storage/db.ts` module.
...
Production imports from `packages/agenthorsy/src/storage/db.ts` are concentrated in 22 source files:

- `packages/agenthorsy/src/account/repo.ts`
- `packages/agenthorsy/src/cli/cmd/db.ts`
- `packages/agenthorsy/src/cli/cmd/import.ts`
- `packages/agenthorsy/src/cli/cmd/stats.ts`
- `packages/agenthorsy/src/control-plane/workspace.ts`
- `packages/agenthorsy/src/index.ts`
- `packages/agenthorsy/src/node.ts`
- `packages/agenthorsy/src/permission/index.ts`
- `packages/agenthorsy/src/project/project.ts`
- `packages/agenthorsy/src/server/projectors.ts`
- `packages/agenthorsy/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/agenthorsy/src/server/shared/fence.ts`
- `packages/agenthorsy/src/session/message-v2.ts`
- `packages/agenthorsy/src/session/projectors.ts`
- `packages/agenthorsy/src/session/prompt.ts`
- `packages/agenthorsy/src/session/session.ts`
- `packages/agenthorsy/src/session/todo.ts`
- `packages/agenthorsy/src/share/share-next.ts`
- `packages/agenthorsy/src/storage/db.ts`
- `packages/agenthorsy/src/sync/index.ts`
- `packages/agenthorsy/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/agenthorsy/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/agenthorsy/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/agenthorsy`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/agenthorsy/src`
- `bun typecheck` from `packages/agenthorsy`
- Relevant package tests from `packages/agenthorsy`, not the repo root
