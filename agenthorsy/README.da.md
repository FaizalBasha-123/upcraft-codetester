...
brew install anomalyco/tap/agenthorsy # macOS og Linux (anbefalet, altid up to date)
brew install agenthorsy              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
Horsy findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/agenthorsy/releases) eller [agenthorsy.ai/download](https://agenthorsy.ai/download).
...
1. `$AGENTHORSY_INSTALL_DIR` - Tilpasset installationsmappe
...
Horsy har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://agenthorsy.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af Horsy, [**se vores docs**](https://agenthorsy.ai/docs).

### Bidrag

Hvis du vil bidrage til Horsy, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på Horsy

Hvis du arbejder på et projekt der er relateret til Horsy og bruger "opencode" som en del af navnet; f.eks. "agenthorsy-dashboard" eller "agenthorsy-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af Horsy-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://agenthorsy.ai/discord) | [X.com](https://x.com/agenthorsy)
