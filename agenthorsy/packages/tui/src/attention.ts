...
import defaultSoundPath from "@agenthorsy-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@agenthorsy-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@agenthorsy-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@agenthorsy-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@agenthorsy-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@agenthorsy-ai/ui/audio/yup-01.mp3" with { type: "file" }
