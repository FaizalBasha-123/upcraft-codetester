...
import type { Definition } from "@agenthorsy-ai/schema/event"
...
export const AgentHorsyEvent = event.schema
export type AgentHorsyEvent = typeof AgentHorsyEvent.Type
export type AgentHorsyEventEncoded = typeof AgentHorsyEvent.Encoded
