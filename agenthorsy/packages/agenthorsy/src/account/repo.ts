...
import { AccountStateTable, AccountTable } from "@agenthorsy-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/AccountRepo") {}
