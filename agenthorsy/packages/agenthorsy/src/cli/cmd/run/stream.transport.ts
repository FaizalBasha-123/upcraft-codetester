...
import type { Event, GlobalEvent, OpencodeClient } from "@agenthorsy-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@agenthorsy/RunStreamTransport") {}
