...
import { HashInsertTool } from "./hash-insert"
import { SwitchModeTool } from "./switch_mode"
import { ValidateTaskTool } from "./validate_task"
import { MergeWorktreeTool } from "./merge_worktree"
import * as Validator from "../validator/validator"
import * as Tool from "./tool"
import { Git } from "@/git"
import { Config } from "@/config/config"
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@agenthorsy-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/ToolRegistry") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const hashInsert = yield* HashInsertTool
    const switchMode = yield* SwitchModeTool
    const validateTask = yield* ValidateTaskTool
    const mergeWorktree = yield* MergeWorktreeTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          hash_insert: Tool.init(hashInsert),
          switch_mode: Tool.init(switchMode),
          validate_task: Tool.init(validateTask),
          merge_worktree: Tool.init(mergeWorktree),
