import type { JsonSchema, LLMRequest, ProviderMetadata } from "@agenthorsy-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@agenthorsy-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @agenthorsy-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
