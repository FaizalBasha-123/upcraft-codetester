...
import type * as SDK from "@agenthorsy-ai/sdk/v2"
...
import { SessionShareTable } from "@agenthorsy-ai/core/share/sql"
...
const disabled = process.env["AGENTHORSY_DISABLE_SHARE"] === "true" || process.env["AGENTHORSY_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/ShareNext") {}
