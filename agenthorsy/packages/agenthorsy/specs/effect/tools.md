...
Practical reference for the current tool-migration state in `packages/agenthorsy`.
...
Tool tests should use the existing Effect helpers in `packages/agenthorsy/test/lib/effect.ts`:
