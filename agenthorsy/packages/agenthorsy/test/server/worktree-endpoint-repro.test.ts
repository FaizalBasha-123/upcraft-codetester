...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      AGENTHORSY_EXPERIMENTAL_WORKSPACES: Flag.AGENTHORSY_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.AGENTHORSY_EXPERIMENTAL_WORKSPACES = original.AGENTHORSY_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
