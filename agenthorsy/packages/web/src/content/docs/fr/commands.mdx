...
Vous pouvez ajouter des commandes personnalisées via la configuration AgentHorsy ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre AgentHorsy [config](/docs/config) :
