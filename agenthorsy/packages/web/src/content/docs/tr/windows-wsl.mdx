---
title: Windows (WSL)
description: En iyi deneyim icin agenthorsy'u WSL'de calistirin.
---
...
- Butunlesik bir gelistirme akisi icin agenthorsy ile birlikte VS Code [WSL eklentisini](https://code.visualstudio.com/docs/remote/wsl) kullanin
- opencode konfigurasyonunuz ve oturumlariniz WSL ortaminda `~/.local/share/agenthorsy/` konumunda saklanir
