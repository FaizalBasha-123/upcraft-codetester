...
Bir kullanıcı `/share` özelliğini etkinleştirirse, görüşme ve onunla ilişkili veriler, bu paylaşım sayfalarını agenthorsy.ai'de barındırmak için kullandığımız hizmete gönderilir.
...
Paketlerin kurumsal kayıt defterinizden yüklenebildiğinden emin olmak için geliştiricilerin agenthorsy'u çalıştırmadan önce özel kayıt defterinde oturum açmaları gerekir.
