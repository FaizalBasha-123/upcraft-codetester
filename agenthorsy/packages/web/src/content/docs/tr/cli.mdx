---
title: CLI
description: agenthorsy CLI seçenekleri ve komutları.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

agenthorsy CLI herhangi bir argüman olmadan çalıştırıldığında varsayılan olarak [TUI](/docs/tui)'yi başlatır.
...
agenthorsy CLI ayrıca aşağıdaki komutlara da sahiptir.
...
opencode, [Models.dev](https://models.dev) adresindeki sağlayıcı listesi tarafından desteklenmektedir, dolayısıyla kullanmak istediğiniz herhangi bir sağlayıcı için API anahtarlarını ayarlamak üzere `opencode auth login` kullanabilirsiniz. Bu `~/.local/share/agenthorsy/auth.json`'de saklanıyor.
...
agenthorsy CLI aşağıdaki global bayrakları destekler.
