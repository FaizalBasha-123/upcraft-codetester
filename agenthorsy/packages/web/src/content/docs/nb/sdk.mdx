---
title: SDK
description: Typesikker JS-klient for AgentHorsy-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

AgentHorsy JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere AgentHorsy programmatisk.
...
Opprett en forekomst av AgentHorsy:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `agenthorsy.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av AgentHorsy, kan du opprette en klientforekomst for å koble til den:
...
```typescript
import type { Session, Message, Part } from "@agenthorsy-ai/sdk"
```
