---
title: TUI
description: استخدام واجهة المستخدم TUI في AgentHorsy.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر AgentHorsy واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل AgentHorsy إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة AgentHorsy في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى AgentHorsy. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من AgentHorsy. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `agenthorsy.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار AgentHorsy بعد الضغط على leader key. القيمة الافتراضية `2000`.
