---
title: TUI
description: Korištenje korisničkog interfejsa AgentHorsy terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AgentHorsy pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje AgentHorsy pokreće TUI za trenutni direktorij.
...
Kada koristite AgentHorsy TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u AgentHorsy. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz AgentHorsy. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `agenthorsy.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo AgentHorsy čeka nakon leader key. Podrazumijevano je `2000`.
