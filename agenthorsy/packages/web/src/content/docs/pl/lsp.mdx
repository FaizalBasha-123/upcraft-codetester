---
title: Serwery LSP
description: AgentHorsy integruje się z serwerami LSP.
---

AgentHorsy może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

AgentHorsy posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i AgentHorsy otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji AgentHorsy.
