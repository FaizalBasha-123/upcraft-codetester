...
Jest to oddzielny plik od `agenthorsy.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo AgentHorsy czeka po naciśnięciu leader key. Domyślnie `2000`.
