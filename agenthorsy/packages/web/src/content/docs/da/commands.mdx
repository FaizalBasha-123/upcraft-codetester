...
Du kan tilføje brugerdefinerede kommandoer gennem AgentHorsy-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din AgentHorsy [config](/docs/config):
