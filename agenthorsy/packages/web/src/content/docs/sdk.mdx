---
title: SDK
description: Type-safe JS client for agenthorsy server.
---
...
Create an instance of agenthorsy:
...
You can pass a configuration object to customize behavior. The instance still picks up your `agenthorsy.json`, but you can override or add configuration inline:
...
If you already have a running instance of agenthorsy, you can create a client instance to connect to it:
