---
title: TUI
description: Arbeite mit AgentHorsy in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AgentHorsy bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet AgentHorsy die TUI im aktuellen Verzeichnis.
...
In der AgentHorsy-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu AgentHorsy hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet AgentHorsy. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `agenthorsy.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
- `leader_timeout` - Steuert, wie lange AgentHorsy nach der leader key wartet. Standard ist `2000`.
