...
You can add custom commands through the AgentHorsy config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your AgentHorsy [config](/docs/config):
