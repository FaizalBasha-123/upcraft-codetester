...
import {
  ...
  type StatsHomeData,
  type StatsLabData,
} from "@agenthorsy-ai/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="AgentHorsy" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent AgentHorsy Go usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
