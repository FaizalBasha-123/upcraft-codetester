...
const releaseId = process.env.AGENTHORSY_RELEASE
if (!releaseId) throw new Error("AGENTHORSY_RELEASE is required")

const version = process.env.AGENTHORSY_VERSION
if (!version) throw new Error("AGENTHORSY_VERSION is required")
...
const macxTarGz = "agenthorsy-desktop-mac-x64.app.tar.gz"
const macaTarGz = "agenthorsy-desktop-mac-arm64.app.tar.gz"
