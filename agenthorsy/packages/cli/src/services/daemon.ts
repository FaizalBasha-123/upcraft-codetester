...
import { createOpencodeClient } from "@agenthorsy-ai/sdk/v2/client"
import { ServerAuth } from "@agenthorsy-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/cli/Daemon") {}
