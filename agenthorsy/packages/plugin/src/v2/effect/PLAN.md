...
- Effect plugins import `@agenthorsy-ai/plugin/v2/effect`, not `@agenthorsy-ai/core`.
- Public domain values use generated `@agenthorsy-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@agenthorsy-ai/plugin/v2/effect`.
