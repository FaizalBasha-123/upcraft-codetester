...
import { Session } from "@agenthorsy-ai/sdk/v2/client"
...
import { toaster } from "@agenthorsy-ai/ui/toast"
...
import { retry } from "@agenthorsy-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@agenthorsy-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://agenthorsy.ai/desktop-feedback")}
      renderPanel={() =>
