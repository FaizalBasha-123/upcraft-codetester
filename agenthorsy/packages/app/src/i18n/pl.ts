export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AgentHorsy.",
  ...
  "dialog.server.description": "Przełącz serwer AgentHorsy, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie AgentHorsy w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie AgentHorsy w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj AgentHorsy w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy jest gotowy.",
  "wsl.onboarding.installAgenthorsyIn": "Zainstaluj AgentHorsy w dystrybucji {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Zainstaluj AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim AgentHorsy będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz AgentHorsy.",
  ...
  "toast.update.description": "Nowa wersja AgentHorsy ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AgentHorsy",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: AgentHorsy nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer AgentHorsy wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd AgentHorsy na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AgentHorsy ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AgentHorsy.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AgentHorsy",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AgentHorsy.",
