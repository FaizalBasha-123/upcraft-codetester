...
> current private `@agenthorsy-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@agenthorsy-ai/ai`
...
- Secondary audience: AgentHorsy and other durable agent runtimes
...
import { LLM } from "@agenthorsy-ai/ai"
import { OpenAI } from "@agenthorsy-ai/ai/providers/openai"
...
```ts
import { Message } from "@agenthorsy-ai/ai"
...
import { LLM, Tool } from "@agenthorsy-ai/ai"
...
AgentHorsy and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@agenthorsy-ai/ai/promise"
import { OpenAI } from "@agenthorsy-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@agenthorsy-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@agenthorsy-ai/ai/provider"
...
@agenthorsy-ai/ai/promise
  Promise/AsyncIterable LLM facade

@agenthorsy-ai/ai/schema
  serializable domain schemas

@agenthorsy-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@agenthorsy-ai/ai/providers/openai
@agenthorsy-ai/ai/providers/anthropic
@agenthorsy-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@agenthorsy-ai/llm`                      | `@agenthorsy-ai/ai`                                           |
...
AgentHorsy should migrate to `generateTurn` / `streamTurn`, preserving its durable
