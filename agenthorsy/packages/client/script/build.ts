...
import { compile, emitEffectImported, emitPromise, write } from "@agenthorsy-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "AgentHorsyEventEncoded",
              import: 'import type { AgentHorsyEventEncoded } from "@agenthorsy-ai/protocol/groups/event"',
            },
          },
        }),
