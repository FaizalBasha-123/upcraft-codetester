...
import { Entry, FileSystem, FindInput, Match } from "@agenthorsy-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@agenthorsy-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/FileSystem") {}
