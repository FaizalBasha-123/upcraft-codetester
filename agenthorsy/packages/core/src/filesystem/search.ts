...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.AGENTHORSY_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
