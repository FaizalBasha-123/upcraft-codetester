<p align="center">
  <a href="https://agenthorsy.ai">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="Logo do Horsy">
    </picture>
  </a>
</p>
...
brew install anomalyco/tap/agenthorsy # macOS e Linux (recomendado, sempre atualizado)
brew install agenthorsy              # macOS e Linux (fórmula oficial do brew, atualiza menos)
sudo pacman -S agenthorsy            # Arch Linux (Stable)
paru -S agenthorsy-bin               # Arch Linux (Latest from AUR)
mise use -g agenthorsy               # qualquer sistema
nix run nixpkgs#agenthorsy           # ou github:anomalyco/agenthorsy para a branch dev mais recente
```
...
O Horsy também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/agenthorsy/releases) ou em [agenthorsy.ai/download](https://agenthorsy.ai/download).
...
1. `$AGENTHORSY_INSTALL_DIR` - Diretório de instalação personalizado
2. `$XDG_BIN_DIR` - Caminho compatível com a especificação XDG Base Directory
3. `$HOME/bin` - Diretório binário padrão do usuário (se existir ou puder ser criado)
4. `$HOME/.agenthorsy/bin` - Fallback padrão
...
O Horsy inclui dois agents integrados, que você pode alternar com a tecla `Tab`.
...
Saiba mais sobre [agents](https://agenthorsy.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o Horsy, [**veja nossa documentação**](https://agenthorsy.ai/docs).

### Contribuir

Se você tem interesse em contribuir com o Horsy, leia os [contributing docs](./CONTRIBUTING.md) antes de enviar um pull request.
...
**Junte-se à nossa comunidade** [Discord](https://agenthorsy.ai/discord) | [X.com](https://x.com/agenthorsy)
