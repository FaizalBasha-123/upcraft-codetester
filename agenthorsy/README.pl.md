...
# Menedżery pakietów
npm i -g agenthorsy-ai@latest        # albo bun/pnpm/yarn
scoop install agenthorsy             # Windows
choco install agenthorsy             # Windows
brew install anomalyco/tap/agenthorsy # macOS i Linux (polecane, zawsze aktualne)
brew install agenthorsy              # macOS i Linux (oficjalna formuła brew, rzadziej aktualizowana)
sudo pacman -S agenthorsy            # Arch Linux (Stable)
paru -S agenthorsy-bin               # Arch Linux (Latest from AUR)
mise use -g agenthorsy               # dowolny system
nix run nixpkgs#agenthorsy           # lub github:anomalyco/agenthorsy dla najnowszej gałęzi dev
```
...
Horsy jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/agenthorsy/releases) lub z [agenthorsy.ai/download](https://agenthorsy.ai/download).
...
1. `$AGENTHORSY_INSTALL_DIR` - Własny katalog instalacji
2. `$XDG_BIN_DIR` - Ścieżka zgodna ze specyfikacją XDG Base Directory
3. `$HOME/bin` - Standardowy katalog binarny użytkownika (jeśli istnieje lub można go utworzyć)
4. `$HOME/.agenthorsy/bin` - Domyślny fallback
...
Horsy zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Dowiedz się więcej o [agents](https://agenthorsy.ai/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji Horsy znajdziesz w [**dokumentacji**](https://agenthorsy.ai/docs).

### Współtworzenie

Jeśli chcesz współtworzyć Horsy, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.
...
**Dołącz do naszej społeczności** [Discord](https://agenthorsy.ai/discord) | [X.com](https://x.com/agenthorsy)
