...
- PR #13942: https://github.com/anomalyco/agenthorsy/pull/13942

## Do Not Translate (Locale Additions)

- `AgentHorsy` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `AgentHorsy Zen`
- `AgentHorsy CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `AgentHorsy`
