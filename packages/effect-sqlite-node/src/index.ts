...
export const TypeId: TypeId = "~@agenthorsy-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@agenthorsy-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@agenthorsy-ai/effect-sqlite-node/NodeSqliteClient")
