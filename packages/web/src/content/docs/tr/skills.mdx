...
- Genel konfigurasyon: `~/.config/agenthorsy/skills/<name>/SKILL.md`
...
Genel tanimlar da `~/.config/agenthorsy/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`agenthorsy.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`agenthorsy.json` icinde):
