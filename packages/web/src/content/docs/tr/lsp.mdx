...
description: AgentHorsy, LSP sunucularınızla bütünleşir.
---

AgentHorsy, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

AgentHorsy, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
