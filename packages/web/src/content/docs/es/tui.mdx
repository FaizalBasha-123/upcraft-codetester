---
title: TUI
description: Usando la interfaz de usuario del terminal AgentHorsy.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AgentHorsy proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar AgentHorsy se inicia TUI para el directorio actual.
...
Cuando utilice AgentHorsy TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a AgentHorsy. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de AgentHorsy. _Alias_: `/quit`, `/q`
...
Esto es independiente de `agenthorsy.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera AgentHorsy después de la leader key. El valor predeterminado es `2000`.
