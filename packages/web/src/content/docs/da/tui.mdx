---
title: TUI
description: Brug af AgentHorsy-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

AgentHorsy giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre AgentHorsy starter TUI for den nuværende mappe.
...
Når du bruger AgentHorsy TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til AgentHorsy. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut AgentHorsy. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `agenthorsy.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe AgentHorsy venter efter leader key. Standard er `2000`.
