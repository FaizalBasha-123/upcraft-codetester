import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@agenthorsy-ai/sdk/v2"
import { SessionTurn } from "@agenthorsy-ai/session-ui/session-turn"
import { SessionReview } from "@agenthorsy-ai/session-ui/session-review"
import { DataProvider } from "@agenthorsy-ai/session-ui/context"
import { FileComponentProvider } from "@agenthorsy-ai/ui/context/file"
import { WorkerPoolProvider } from "@agenthorsy-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@agenthorsy-ai/ui/logo"
import { IconButton } from "@agenthorsy-ai/ui/icon-button"
import { ProviderIcon } from "@agenthorsy-ai/ui/provider-icon"
import { iife } from "@agenthorsy-ai/core/util/iife"
import { Binary } from "@agenthorsy-ai/core/util/binary"
import { NamedError } from "@agenthorsy-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@agenthorsy-ai/ui/tabs"
import { MessageNav } from "@agenthorsy-ai/session-ui/message-nav"
import { FileSSR } from "@agenthorsy-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@agenthorsy-ai/session-ui/pierre/worker").then((m) => ({
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | AgentHorsy</Title>
              </Show>
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://agenthorsy.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
