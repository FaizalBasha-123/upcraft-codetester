...
import { EventSequenceTable, EventTable } from "@agenthorsy-ai/core/event/sql"
...
import { WorkspaceEvent } from "@agenthorsy-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AGENTHORSY_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AGENTHORSY_WORKSPACE_ID: config.id,
        AGENTHORSY_EXPERIMENTAL_WORKSPACES: "true",
