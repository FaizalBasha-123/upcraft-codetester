...
import { ProjectDirectoryTable, ProjectTable } from "@agenthorsy-ai/core/project/sql"
import { ProjectDirectories } from "@agenthorsy-ai/core/project/directories"
...
import { which } from "@agenthorsy-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.AGENTHORSY_FAKE_VCS)
