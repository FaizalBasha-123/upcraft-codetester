...
import { PermissionV1 } from "@agenthorsy-ai/core/v1/permission"
import { Slug } from "@agenthorsy-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@agenthorsy-ai/llm"
import { InstallationVersion } from "@agenthorsy-ai/core/installation/version"
...
import { locationServiceMapLayer } from "@agenthorsy-ai/core/location-services"
...
import { PartTable, SessionTable } from "@agenthorsy-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@agenthorsy-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".agenthorsy", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/Session") {}
