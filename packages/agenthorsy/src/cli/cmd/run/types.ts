// Shared type vocabulary for the direct interactive mode (`agenthorsy --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@agenthorsy-ai/sdk/v2"
import type { TuiConfig } from "@agenthorsy-ai/tui/config"
