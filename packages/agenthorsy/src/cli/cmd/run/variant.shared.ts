...
//
// The saved variant persists across sessions in ~/.local/state/agenthorsy/model.json
...
class Service extends Context.Service<Service, VariantService>()("@agenthorsy/RunVariant") {}
