...
import { makeApi } from "@agenthorsy-ai/protocol/api"
import { LocationMiddleware } from "@agenthorsy-ai/server/location"
import { SessionLocationMiddleware } from "@agenthorsy-ai/server/middleware/session-location"
...
export const AgentHorsyHttpApi = HttpApi.make("opencode")
