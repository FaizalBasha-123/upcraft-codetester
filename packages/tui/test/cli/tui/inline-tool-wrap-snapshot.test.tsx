...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/agenthorsy/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/agenthorsy (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/agenthorsy/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/agenthorsy/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AGENTHORSY_DB|AGENTHORSY_DB|AGENTHORSY_DEV|Global\\.Path\\.data|data =" in packages/agenthorsy/src (115 matches)',
  },
] as const
