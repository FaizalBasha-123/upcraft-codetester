export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в AgentHorsy.",
  ...
  "dialog.server.description": "Переключите сервер AgentHorsy к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка AgentHorsy в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление AgentHorsy в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите AgentHorsy в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "AgentHorsy готов к работе.",
  "wsl.onboarding.installAgenthorsyIn": "Установите AgentHorsy в {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Установить AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в AgentHorsy требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте AgentHorsy.",
  ...
  "toast.update.description": "Новая версия AgentHorsy ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде AgentHorsy",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что AgentHorsy пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер AgentHorsy внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения AgentHorsy",
  ...
  "settings.general.row.appearance.description": "Настройте как AgentHorsy выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли AgentHorsy системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление AgentHorsy.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске AgentHorsy",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию AgentHorsy.",
