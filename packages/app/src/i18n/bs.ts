export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AgentHorsy-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AgentHorsy-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AgentHorsy-u.",
  ...
  "dialog.server.description": "Promijeni na koji se AgentHorsy server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera AgentHorsy u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AgentHorsy u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj AgentHorsy u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy je spreman.",
  "wsl.onboarding.installAgenthorsyIn": "Instaliraj AgentHorsy u distribuciji {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Instaliraj AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi AgentHorsy mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori AgentHorsy.",
  ...
  "toast.update.description": "Nova verzija AgentHorsy-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AgentHorsy timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AgentHorsy još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AgentHorsy server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AgentHorsy-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako AgentHorsy izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AgentHorsy prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AgentHorsy-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AgentHorsy pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AgentHorsy-a.",
