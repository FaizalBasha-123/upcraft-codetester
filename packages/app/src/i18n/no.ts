...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i AgentHorsy.",
  ...
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AgentHorsy.",
  ...
  "dialog.server.description": "Bytt hvilken AgentHorsy-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AgentHorsy ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AgentHorsy-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AgentHorsy ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AgentHorsy-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AgentHorsy",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AgentHorsy ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om AgentHorsy skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan AgentHorsy er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AgentHorsy starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AgentHorsy.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker AgentHorsy i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer AgentHorsy i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater AgentHorsy i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy er klar.",
  "wsl.onboarding.installAgenthorsyIn": "Installer AgentHorsy i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før AgentHorsy kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter AgentHorsy på nytt.",
