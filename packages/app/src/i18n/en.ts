export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AgentHorsy",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AgentHorsy.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "AgentHorsy Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AgentHorsy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AgentHorsy.",
  ...
  "dialog.server.description": "Switch which AgentHorsy server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AgentHorsy...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AgentHorsy in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AgentHorsy...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AgentHorsy in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AgentHorsy in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AgentHorsy",
  "wsl.onboarding.opencodeReadyIn": "AgentHorsy is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AgentHorsy is ready.",
  "wsl.onboarding.installAgenthorsyIn": "Install AgentHorsy in {{distro}}.",
  "wsl.onboarding.installAgenthorsy": "Install AgentHorsy",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AgentHorsy not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AgentHorsy can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AgentHorsy could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AgentHorsy.",
  ...
  "toast.update.description": "A new version of AgentHorsy ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AgentHorsy team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AgentHorsy does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentHorsy includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AgentHorsy server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AgentHorsy",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how AgentHorsy looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AgentHorsy follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AgentHorsy is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AgentHorsy launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AgentHorsy.",
