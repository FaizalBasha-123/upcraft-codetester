...
import { isSessionNotFoundError, isUnauthorizedError, AgentHorsy } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = AgentHorsy.make({ baseUrl: "http://localhost:3000" })
