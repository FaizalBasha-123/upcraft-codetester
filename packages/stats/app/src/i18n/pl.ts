export const dict = {
  "app.title": "Rankingi użycia modeli AI | AgentHorsy Data",
  "app.description":
    "Przeglądaj użycie AgentHorsy Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny AgentHorsy Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AgentHorsy na GitHub",
  "header.github": "GitHub",
  "header.tryAgentHorsy": "Wypróbuj AgentHorsy",
  ...
  "footer.homeAria": "Strona główna AgentHorsy",
  ...
  "home.topModelsDescription": "Użycie modeli w AgentHorsy Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AgentHorsy Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AgentHorsy Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w AgentHorsy Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AgentHorsy.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AgentHorsy",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AgentHorsy",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AgentHorsy z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AgentHorsy Data",
  "model.description":
    "Zobacz dane użycia {{model}} w AgentHorsy Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AgentHorsy Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AgentHorsy Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AgentHorsy Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AgentHorsy Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AgentHorsy Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AgentHorsy Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AgentHorsy Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AgentHorsy Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AgentHorsy Go.",
  ...
  "model.geoDescription": "Tokeny modelu AgentHorsy Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne AgentHorsy Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AgentHorsy Go.",
