export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | AgentHorsy Data",
  "app.description":
    "Esplora l'utilizzo di AgentHorsy Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo AgentHorsy Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a AgentHorsy su GitHub",
  "header.github": "GitHub",
  "header.tryAgentHorsy": "Prova AgentHorsy",
  ...
  "footer.homeAria": "Home AgentHorsy",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in AgentHorsy Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di AgentHorsy Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | AgentHorsy Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in AgentHorsy Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di AgentHorsy.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in AgentHorsy",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di AgentHorsy",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token AgentHorsy negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | AgentHorsy Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in AgentHorsy Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di AgentHorsy Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo AgentHorsy Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo AgentHorsy Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di AgentHorsy Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di AgentHorsy Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di AgentHorsy Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token AgentHorsy Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di AgentHorsy Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione AgentHorsy Go.",
  ...
  "model.geoDescription": "Token del modello AgentHorsy Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica AgentHorsy Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token AgentHorsy Go.",
