...
import type { Data, Definition, Payload } from "@agenthorsy-ai/schema/event"
...
import { Durable } from "@agenthorsy-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@agenthorsy-ai/schema/event").ID
export type { Data, Definition, Payload } from "@agenthorsy-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/Event") {}
