...
import { FileSystemWatcher } from "@agenthorsy-ai/schema/filesystem-watcher"
...
declare const AGENTHORSY_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AGENTHORSY_LIBC === "undefined" ? undefined : AGENTHORSY_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.AGENTHORSY_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.AGENTHORSY_EXPERIMENTAL_FILEWATCHER)) {
