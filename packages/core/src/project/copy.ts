...
import { Event } from "@agenthorsy-ai/schema/project-directories"
import { ProjectCopy } from "@agenthorsy-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@agenthorsy/ProjectCopy") {}
